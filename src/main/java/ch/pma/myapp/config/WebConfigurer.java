...
import ch.pma.myapp.web.filter.CachingHttpHeadersFilter;
import ch.pma.myapp.web.filter.StaticResourcesProductionFilter;
import ch.pma.myapp.web.filter.gzip.GZipServletFilter;
